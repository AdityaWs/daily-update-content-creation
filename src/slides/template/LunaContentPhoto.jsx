...
export default function LunaContentPhoto({ image, judul, materi, img_object_fit = 'cover', img_object_position = 'top', index = 1 }) {
  ...
  return (
    <article className="relative h-[720px] w-[540px] bg-white">
      {image_to_display}
      <div className="absolute bottom-0 left-0 h-[25%] w-full bg-linear-to-t from-blue-900 to-blue-950/0 opacity-80"></div>
