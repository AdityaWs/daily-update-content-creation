...
export default function DailyUpdateContentAside({ image, judul, materi, img_object_fit = 'cover', img_object_position = 'top', index = 1 }) {
  ...
  return (
    <article className="relative h-[720px] w-[540px] bg-white">
      ...
      <div className="relative">
        <div className="absolute top-0 left-0 -translate-y-[80px] w-[80%] p-8 bg-white">
