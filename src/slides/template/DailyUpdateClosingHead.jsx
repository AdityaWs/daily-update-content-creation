...
export default function DailyUpdateClosingHead({ image, judul, materi, img_object_fit = 'cover', img_object_position = 'top', index = 1 }) {
  ...
  return (
    <article className="relative h-[720px] w-[540px] bg-white">
      {image_to_display}
      <div className="absolute h-full w-full top-0 left-0 p-16 pt-32 bg-red-900/90">
