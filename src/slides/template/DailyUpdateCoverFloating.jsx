...
export default function DailyUpdateCoverFloating({ image, judul, materi, img_object_fit = 'cover', img_object_position = 'top', index = 1 }) {
  ...
  return (
    <article className="relative h-[720px] w-[540px] bg-white">
      ...
      <div className="absolute bottom-[10%] w-[90%] right-[50%] translate-x-[50%] p-4 pb-8 bg-red-900 shadow-red-950 shadow-[8px_8px]">
