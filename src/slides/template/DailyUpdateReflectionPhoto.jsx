...
export default function DailyUpdateReflectionPhoto({ image, judul, materi, img_object_fit = 'cover', img_object_position = 'top', index = 1 }) {
  ...
  return (
    <article className="relative h-[720px] w-[540px] bg-white">
      {image_to_display}
      <div className="absolute bottom-0 left-0 h-[25%] w-full bg-linear-to-t from-red-900 to-red-950/0"></div>
      ...
      <div className="absolute top-[60%] left-[50%] -translate-x-[50%] -translate-y-[80px] w-[80%] p-4 bg-white shadow-red-950 shadow-[8px_8px]">
