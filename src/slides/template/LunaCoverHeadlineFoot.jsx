...
export default function LunaCoverHeadlineFoot({ image, judul, materi, img_object_fit = 'cover', img_object_position = 'top', index = 1 }) {
  ...
  return (
    <article className="relative h-[720px] w-[540px] bg-white">
      ...
      <div className="absolute top-0 left-0 h-[30%] w-full bg-linear-to-b from-blue-950/50 to-blue-950/0"></div>
      <div className="absolute top-0 left-0 h-[10%] w-full bg-blue-950"></div>
      <img src={logo} className="absolute top-0 left-0 h-[10%] pl-3" />
      <div className="absolute bottom-0 left-0 h-[43%] p-8 pb-16 bg-blue-900">
